package com.engine.rule.config;
...
public class DroolsBeanFactory {
    ...
    private static final String RULES_PATH = "com/engine/rule/";
...
//        List<String> rules=Arrays.asList("BackwardChaining.drl","SuggestApplicant.drl","Product_rules.xls");
        List<String> rules=Arrays.asList("Product_rules.xls", "Discount.xls");
...
//        kieFileSystem.write(ResourceFactory.newClassPathResource("com/baeldung/drools/rules/SuggestApplicant.drl"));
        kieFileSystem.write(ResourceFactory.newClassPathResource("com/engine/rule/Product_rules.xls"));
        kieFileSystem.write(ResourceFactory.newClassPathResource("com/engine/rule/Discount.xls"));
